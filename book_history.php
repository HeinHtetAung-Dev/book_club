    ...
    top:50px;
                        ...
                        <div class="booksmedia-fullwidth" >
                              ...
                              <div class="container">
                                  <div class="row">
                                      <?php
                                      $q1 = "SELECT * FROM book WHERE b_catagory = 'History' LIMIT $page_one,8";
                                      $b_category_history_result = mysqli_query($conn,$q1);
                                      while ($row = mysqli_fetch_assoc($b_category_history_result)) {
                                          $b_id = $row['b_id'];
                                          $b_name = $row['b_name'];
                                          ...
                                          <img src="images/category/<?php echo $b_image?>" alt="Book" style=  "height:300px; width:240px;margin-bottom: 30px;">
                                            <div class="overlay" style="margin-bottom: 30px;">
                                                  <div class="text col-md-12">
                                                    ...
                                                    <br>
                                                    <a href="book_detail.php?b_id=<?php echo $b_id;?>"><img alt="Book" src="images/category/<?php echo $book_image;?>" class="btn btn_group"><h4>Read More</h4></a>
                                                    </p>   
                                                  </div>
                                            </div>
                                      </div>
                              ...
                              <nav class="navigation pagination text-center">
                                  ...
                                  <div class="pager">
                                          <?php 
                                              for($i=1 ; $i<=$count ; $i++)
                                                  if($i==$page){
                                                  echo "<li><a class='active_link' href='book_history.php?page=$i'>$i</a></li>";
                                                  }else{
                                                       echo "<li><a href='book_history.php?page=$i'>$i</a></li>";
                                                  }
                                           ?>
                                  </div>
                              </nav>
