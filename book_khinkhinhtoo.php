    ...
    top:50px;
                        ...
                        <div class="booksmedia-fullwidth" >
                                <?php 
                                    ...
                                    $post_count_query="SELECT * FROM book WHERE b_author='Khin Khin Htoo' ";
                              ...
                              <div class="container">
                                  <div class="row">
                                      <?php
                                      $q1 = "SELECT * FROM book WHERE b_author = 'Khin Khin Htoo' LIMIT $page_one,8";
                              ...
                              <nav class="navigation pagination text-center">
                                  ...
                                  <div class="pager">
                                          <?php 
                                              for($i=1 ; $i<=$count ; $i++)
                                                  if($i==$page){
                                                  echo "<li><a class='active_link' href='book_khinhtoo.php?page=$i'>$i</a></li>";
                                                  }else{
                                                       echo "<li><a href='book_khinhtoo.php?page=$i'>$i</a></li>";
                                                  }
                                           ?>
                                  </div>
                              </nav>
