    ...
    top:50px;
                        ...
                        <div class="booksmedia-fullwidth" >
                                <?php 
                                    ...
                                    $post_count_query="SELECT * FROM book WHERE b_author='Laetwinthr Saw Chit' ";
                              ...
                              <div class="container">
                                  <div class="row">
                                      <?php
                                      $q1 = "SELECT * FROM book WHERE b_author = 'Laetwinthr Saw Chit' LIMIT $page_one,8";
                                      $b_category_khinhtoo_result = mysqli_query($conn,$q1);
                                      while ($row = mysqli_fetch_assoc($b_category_khinhtoo_result)) {
                                          $b_id = $row['b_id'];
                                          $b_name = $row['b_name'];
                              ...
                              <nav class="navigation pagination text-center">
                                  ...
                                  <div class="pager">
                                          <?php 
                                              for($i=1 ; $i<=$count ; $i++)
                                                  if($i==$page){
                                                  echo "<li><a class='active_link' href='book_laltwinthrsawchit.php?page=$i'>$i</a></li>";
                                                  }else{
                                                       echo "<li><a href='book_laltwinthrsawchit.php?page=$i'>$i</a></li>";
                                                  }
                                           ?>
                                  </div>
                              </nav>
