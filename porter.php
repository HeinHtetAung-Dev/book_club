<?php
 ...
 private static function step2($word)
        ...
        //     // Part a
        //     if (strtok($word, -1) == '-') {
        //         if (self::m(strtok($word, 0, -1)) > 1) {
        //             self::replace($word, '-', '');

        //         } else if (self::m(strtok($word, 0, -1)) == 1) {

        //             if (!self::cvc(strtok($word, 0, -1))) {
        //                 self::replace($word, '-', '');
        //             }
        //         }
        //     }
        ...
        //     // Part b
        //     if (self::m($word) > 1 AND self::doubleConsonant($word) AND strtok($word, -1) == '-') {
        //         $word = strtok($word, 0, -1);
        //     }
        ...
        // }
          ...
          private static function step5($word)
        {
            for($word = strtok($word, "_-.!@#$%^&*()+=<>/,.[]\{}|'`~?;:"); $word!==false; $word = strtok("_-.!@#$%^&*()+=<>/,.[]\{}|'`~?;:"))
             {
